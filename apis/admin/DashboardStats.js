...
async function DashboardStats(req, res) {
  try {
    ...
    return res.status(200).json({
      ...
      data: {
        totalUsers, totalCategories, totalProducts, availableProducts,
        outOfStock, totalOrders, placedOrders, shippedOrders,
        deliveredOrders, cancelledOrders, totalRevenue, avgRating,
